document.addEventListener("DOMContentLoaded", function () {
      ...
      },
      {
        ...
        questions: [
          ...
          },
          {
            questionType: "mcq",
            question:
              "Which desert is located in the Indian state of Rajasthan?",
            options: [
              "Thar Desert",
              "Sahara Desert",
              "Gobi Desert",
      ...
      },
      {
        ...
        questions: [
          ...
          },
          {
            questionType: "mcq",
            question:
              "Which Indian poet was known as the 'Nightingale of India'?",
            options: [
              "Sarojini Naidu",
              "Rabindranath Tagore",
              "Subramania Bharati",
          ...
          },
          {
            questionType: "mcq",
            question:
              "Who is the author of the famous poem 'Where the Mind is Without Fear'?",
            options: [
              "Rabindranath Tagore",
              "Sarojini Naidu",
              "Gulzar",
          ...
          },
          {
            questionType: "mcq",
            question:
              "Which Indian writer's autobiography is titled 'My Experiments with Truth'?",
            options: [
              "Mahatma Gandhi",
              "Jawaharlal Nehru",
              "Rabindranath Tagore",
      ...
      },
      {
        ...
        questions: [
          ...
          },
          {
            questionType: "mcq",
            question:
              "Which civilization is known for its advanced city planning and sewage systems?",
            options: [
      ...
      },
      {
        ...
        questions: [
          ...
          },
          {
            questionType: "mcq",
            question:
              "What is the term used to describe the process of making a computer program bug-free?",
  ...
  function startQuiz(index) {
    ...
    function showQuestions() {
      ...
      let question = currentQuestions[currentQuestionsIndex];
    ...
    function endQuiz() {
      ...
      questionContainer.innerHTML = `
            <img src="./images/quiz-end.jpg" alt="quizEnd">
  ...
  document.querySelector(".random-quiz").addEventListener("click",function(){
